...
def get_cia_pacc(registro):
    ...
    elif codigo == 24: return 7; # "SANTA LUCIA, S.A. COMPAÑIA DE SEGUROS Y REASEGUROS" , "cia_abre
    elif codigo == 25: return 198; # "AXA PENSIONES S.A ENT.GEST.DE FONDOS" , "cia_abreviatura" : "AX
    elif codigo == 12: return 14; # "OCASO, S.A., COMPAÑIA DE SEGUROS Y REASEGUROS." , "cia_abreviat
    ...
    elif codigo == 2 : return 33; #"ARAG SE SUC.ESPAÐA" , "cia_abreviatura" : "ARAG" , "cod_interno_
    elif codigo == 1 : return 13; #"ALLIANZ, COMPAÑIA DE SEGUROS Y REASEGUROS, SOCIEDAD ANONIMA" , "
    elif codigo == 22: return 0; # "W.R. BERKLEY EUROPE AG SUC. ESPAÑA" , "cia_abreviatura" : "BERK
    ...
    elif codigo == 27: return 20; # "W.R. BERKLEY EUROPE AG SUC. ESPAÑA" , "cia_abreviatura" : "BERK
    elif codigo == 5 : return 4; #"DKV SEGUROS Y REASEGUROS, SOCIEDAD ANONIMA ESPAÑOLA" , "cia_abre
    elif codigo == 11: return 38; # "REALE SEGUROS GENERALES, S.A." , "cia_abreviatura" : "REALE" , 
    elif codigo == 17: return 53; # "AEGON ESPAÐA, SOCIEDAD ANËNIMA DE SEGUROS Y REASEGUROS" , "cia_
    elif codigo == 23: return 21; # "AXA AURORA VIDA, S.A. DE SEGUROS Y REASEGUROS" , "cia_abreviatu
    elif codigo == 13: return 9; # "ZURICH INSURANCE PLC SUC.ESPAÑA" , "cia_abreviatura" : "ZURICH"
    elif codigo == 4 : return 2; #"AXA SEGUROS GENERALES, S. A. DE SEGUROS Y REASEGUROS" , "cia_abr
    elif codigo == 9 : return 34; #"LIBERTY SEGUROS, COMPAÑIA DE SEGUROS Y REASEGUROS, S.A." , "cia_
    elif codigo == 7 : return 8; #"GENERALI ESPAÑA, SOCIEDAD ANÓNIMA DE SEGUROS Y REASEGUROS" , "ci
...
def get_ramo_pacc(registro):
    ...
    elif codigo == '21614': return 000 # VI√ëEDO
    ...
    elif codigo == '20605': return 117 # S.O.DECENAL DA√ëOS
    ...
    elif codigo == '20103': return 210 # T.R.DA√ëOS
